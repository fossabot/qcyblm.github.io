module.exports = {
	...
	head: [
		...
		['link', {rel:'icon', href: '/favicon.ico', type:'image/vnd.microsoft.icon', sizes:"64x64"}],
		['link', {rel:'shortcut icon', href: '/favicon.ico', type:'image/vnd.microsoft.icon'}],
		['link', {rel:'apple-touch-icon', href: '/icons/apple-touch-icon-152x152.png', type:'image/vnd.sealed.png'}],
		['link', {rel:'mask-icon', href: '/icons/safari-pinned-tab.svg', color: '#0058CF', type: 'application/vnd.oipf.dae.svg+xml'}],
		['link', {rel:"apple-touch-icon-precomposed", sizes:"114x114", href: "apple-icon-114.png", type: "image/vnd.sealed.png"}],
